...
Prefix:        /usr/local
Requires:      dbus-devel, glib2-devel, boost, openssl, rh-python36, yum-utils, gcc, autoconf, curl, libtool,  rsyslog,  wget, zlib, libuuid, avahi, sudo
AutoReqProv:   no
...
##--------------------------------------------------------------------
##
## This script is used to modifies links or other files associated with foglamp, and/or removes files created by the package.
##
